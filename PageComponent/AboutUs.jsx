...
import pfp2 from '../images/pfp2.jpeg';
...
const AboutUs = () => {
  ...
  <div className="col-md-3">
    <TeamMemberCard name="Sherlyn S. Olalo" image={pfp5} motto="Never give up, great things take time." />
  </div>
  <div className="col-md-3">
    <TeamMemberCard name="Ericka Joyce S. Cagata" image={pfp2} motto="If at first, you don't succeed, redefine success." />
  </div>
  <div className="col-md-3">
    <TeamMemberCard name="Lettice V. Tordillo" image={pfp3} motto="Do good and good will come to you." />
  </div>
  <div className="col-md-3">
    <TeamMemberCard name="Aj Brian L. Cajegas" image={pfp4} motto="Make progress with small steps every day."  />
  </div>
</div>
    </div>
  );
